...
namespace Tortuga.Graphics
{
    ...
    public class Device
    {
        ...
        private unsafe DeviceQueueFamilies FindDeviceQueueIndices()
        {
            ...
            int bestGraphics = -1;
            int bestTransfer = -1;
            uint bestComputeCount = 0;
            uint bestGraphicsCount = 0;
            uint bestTransferCount = 0;
            ...
            for (int i = 0; i < queueFamilyCount; i++)
            {
                ...
                if ((queueFamily.queueFlags & VkQueueFlags.Compute) != 0)
                {
                    ...
                    {
                        bestCompute = i;
                        bestComputeCount = queueFamily.queueCount;
                    }
                    else
                        compute = i;
                ...
                if ((queueFamily.queueFlags & VkQueueFlags.Graphics) != 0)
                {
                    ...
                    {
                        bestGraphics = i;
                        bestGraphicsCount = queueFamily.queueCount;
                    }
                    else
                        graphics = i;
                ...
                if ((queueFamily.queueFlags & VkQueueFlags.Transfer) != 0)
                {
                    ...
                    {
                        bestTransfer = i;
                        bestTransferCount = queueFamily.queueCount;
                    }
                    else
                        transfer = i;
            ...
            if (bestCompute > -1)
            {
                ...
                data.Transfer.Count = bestComputeCount;
            }
            else if (compute > -1)
            ...
            if (bestGraphics > -1)
            {
                ...
                data.Graphics.Count = bestGraphicsCount;
            }
            else if (graphics > -1)
            ...
            if (bestTransfer > -1)
            {
                ...
                data.Transfer.Count = bestTransferCount;
            }
            else if (transfer > -1)
