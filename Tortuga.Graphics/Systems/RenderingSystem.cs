...
namespace Tortuga.Graphics
{
    ...
    public class RenderingSystem : Core.BaseSystem
    {
        ...
        private Dictionary<Graphics.Material, Dictionary<Graphics.Mesh, List<RenderMesh>>> _previousMaterialInstance;
        ...
        public override void OnEnable()
        {
            ...
            var meshes = MyScene.GetComponents<RenderMesh>();
            ...
            var materialInstancing = new Dictionary<Graphics.Material, Dictionary<Graphics.Mesh, List<RenderMesh>>>();
            foreach (var mesh in meshes)
            {
                if (materialInstancing.ContainsKey(mesh.Material) == false)
                    materialInstancing[mesh.Material] = new Dictionary<Graphics.Mesh, List<RenderMesh>>();
                if (materialInstancing[mesh.Material].ContainsKey(mesh.Mesh) == false)
                    materialInstancing[mesh.Material][mesh.Mesh] = new List<RenderMesh>();
