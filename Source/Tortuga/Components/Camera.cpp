...
void Camera::OnCreate()
{
    ...
    this->Framebuffer = Graphics::Vulkan::Framebuffer::Create(device, this->ResolutionWidth, this->ResolutionHeight, Core::Engine::GetVulkanRenderPass(), {this->ColorImageView, this->DepthImageView});
